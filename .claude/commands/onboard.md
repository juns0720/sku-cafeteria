...
프론트: React 19 / Vite / TailwindCSS v3 / React Query v5 / Pretendard CDN
...
6. docs/DESIGN.md         ← 디자인 토큰·컴포넌트 절대 규칙
...
### 주의사항
(Known Issues + 디자인 절대 규칙 중 현 단계와 관련된 것 + V3-T19 DROP 등 위험 작업 경고)
